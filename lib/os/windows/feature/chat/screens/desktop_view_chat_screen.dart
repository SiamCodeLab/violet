...
class DesktopViewChatScreen extends StatelessWidget {
                  ...
                  Expanded(
                    child: Obx(() {
                      ...
                      return controller.currentMessages.isEmpty
                          ? _DesktopEmptyState(image: initialQuery)
                ...
                if (!isCollapsed)
                  Expanded(
                    child: Obx(() {
                      ...
                      if (widget.controller.allSessions.isEmpty) {
                        return Padding(
                      ...
                      return ListView.builder(
                        ...
                        itemCount: widget.controller.allSessions.length,
                        itemBuilder: (_, index) {
                          final session = widget.controller.allSessions[index];
                          final isActive =
